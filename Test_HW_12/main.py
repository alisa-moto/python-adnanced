from HW_12.data_base.sql_units.sql_data_base import SQLDataBase

import os

from HW_12.library import Library
...
if __name__ == '__main__':
    ...
    storage = SQLDataBase('postgres', 'postgres', 'pass123')
    lib = Library(storage)


    # execute_command(choose_command())
    print(storage.load_books_from_db())
